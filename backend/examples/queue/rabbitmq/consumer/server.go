...
import (
	...
	"github.com/insight/backend/pkg/queue/rabbitmq"
	"github.com/insight/backend/pkg/queue/rabbitmq/options"
	RabbitMQ "github.com/insight/backend/pkg/transport/consumer/rabbitmq"
)
